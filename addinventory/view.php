        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                <nav>
                    ...
                    <a href="addinventory.php">Add Stock</a> |
                    <a href="#">View</a> 
                </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <table class="table table-dark">
                             ...
                             <a href="addinventory.php" type="button"  data-toggle="modal"  class="btn btn-success btn-sm">Add Stock</a><br><br>
                        ...
                        // if(isset($_POST['searchdetails'])){
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th scope="col">OIL name- Unite</th>

                                    <th scope="col">Total Container</th>

                                    <th scope="col">1 Liter price</th>

                                    <th scope="col">Total liters</th>

                                    <!-- <th scope="col">Total liter price</th> -->

                                    <!-- <th scope="col">Total container price</th> -->
                            ...
                            <tbody style="background-color: #f7f2f23b;">
                                ...
                                <?php 
                                    ...
                                    $b->select("product_import","*",
                                                "product_import.Is_active = 1",
                                                null,
                                                "brand as t2",
                                                "t2.id = product_import.brand_id"
                                                );
                                ...
                                <?php $sno = 1; while ($row = mysqli_fetch_assoc($result)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><?php echo "Jeevi"; // $row['customer_id']; ?> -->
                                        ...
                                        <!-- <td><?php if($row['status']==0){echo 'Pending';}else{echo 'Delivered';}?></td> -->
                                        
                                        <!-- <td><?php echo $row['total_container_price']; ?></td> -->
 ...
 -->
            ...
            <tr class="item">
               ...
               <td style="width:25%;">
                ...
                <td style="width:10%; text-align:right;">
                    <?php $value = $row['product_price']; echo sprintf("%.2f", $value);?>
                </td>
                 <td style="width:15%; text-align:right;">
                   <?php $value = $row['GST_rate']; echo sprintf("%.2f", $value.'%');?>
                </td>
                 <td style="width:15%; text-align:right;">
                    57.97
                </td>
                 <td style="width:15%; text-align:right;">
                    <?php $value = $row['product_total_GST_amount']; echo sprintf("%.2f", $value.'%');?>
                </td>
            </tr>
            <hr>
            <tr class="item">
